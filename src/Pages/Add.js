      ...
      <section className='p-4 sm:p-10 w-full bg-primary/20'>
        <form onSubmit={onSubmitHandler} className='flex flex-col gap-y-5 max-w-[555px]'>
          ...
          <div className='flex flex-col gap-y-2'>
            ...
            <textarea onChange={onChangeHandler} value={data.description} className='ring-1 ring-slate-900/10 py-1 px-3 outline-none resize-none' name="description" id="" rows={'6'} placeholder='Write content here...' required></textarea>
          </div>
          <div className='flex items-center gap-x-6 text-gray-900/70 medium-15'>
            ...
            <div className='flex flex-col gap-y-2'>
              <p>Product price</p>
              <input onChange={onChangeHandler} value={data.price} name='price' type="number" placeholder='$20' className=' ring-1 ring-slate-900/10 pl-2 w-24 outline-none' />
            </div>
          </div>
